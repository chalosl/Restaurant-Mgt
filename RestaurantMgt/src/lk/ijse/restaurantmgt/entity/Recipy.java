...
public class Recipy {
    ...
    public Recipy(String foodId, String foodName, String ingrediantId, String ingrediant_Name) {
        this.foodId = foodId;
    ...
    public String toString() {
        return "Recipy{" + "foodId=" + foodId + ", foodName=" + foodName + ", ingrediantId=" + ingrediantId + ", ingrediant_Name=" + ingrediant_Name + '}';
    }
